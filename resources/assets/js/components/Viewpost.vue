<template id="post">
    <div>
        <button  data-toggle="modal" :data-target="'#'+toggleId" class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i>Show</button>
        <div :id="toggleId" class="modal fade editmodale">
